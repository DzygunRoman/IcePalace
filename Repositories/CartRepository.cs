...
namespace AcePalace.Repositories
{
    ...
    {
        private readonly AcePalaceContext _db;
        private readonly UserManager<IdentityUser> _userManager;
        private readonly IHttpContextAccessor _httpContextAccessor;
       // private readonly IWebHostEnvironment _webHostEnvironment;
        public CartRepository(AcePalaceContext db, UserManager<IdentityUser> userManager, IHttpContextAccessor httpContextAccessor)
        {
            _db = db;
        ...
        {           
            ...
            try
            {
                ...
                var sheduleTime = _db.Shedules
                    .Where(a => a.DateTime == model.DateTime)
                    .Where(b => DateTime.Now < model.DateTime);
                if (sheduleTime == null)
                    throw new Exception("Занятия в данное время не проводятся");
                var order = new Order
                    {
                        UserId = userId,
